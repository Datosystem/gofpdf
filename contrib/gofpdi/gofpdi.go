/*
Package gofpdi wraps the gofpdi PDF library to import existing PDFs as templates. See github.com/Datosystem/gofpdi
...
import (
	realgofpdi "github.com/Datosystem/gofpdi"
	"io"
)
